...
namespace FinalProject.Areas.FinalArea.Controllers
{
    ...
    public class AccountAdminController : Controller
    {
        ...
        public AccountAdminController(AppDbContext context, UserManager<AppUser> userManager, SignInManager<AppUser> signInManager, RoleManager<IdentityRole> roleManager)
        {
            _context = context;
